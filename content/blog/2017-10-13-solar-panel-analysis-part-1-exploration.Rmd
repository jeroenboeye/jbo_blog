...
solar_df%>%
  ...
  geom_point(alpha = 0.6, size = rel(0.9)) +
...
```
Temperatures above 35°C are caused by direct sunlight. Notice how before 11AM this rarely happens due to the shade of the Eastern tree. You can also see that in the last couple of months I've had some issues with missing data.
